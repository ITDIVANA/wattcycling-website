			...
			if(windowWidth>768){
				...
				if(jQuery(".page-template-template-location-page").length > 0) {
					...
					if(locationId !=''){
						...
						jQuery('.page-template-template-location-page .wpb_row.vc_row.vc_row-fluid.mk-fullwidth-true .vc_col-sm-12.wpb_column.column_container._.height-full').attr("id",locationId).attr('id');
						jQuery("#"+locationId).css({'margin-bottom':'40px'});
