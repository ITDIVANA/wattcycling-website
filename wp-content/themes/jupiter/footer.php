...
<footer id="mk_page_footer">
    ...
    ?>
<script src="<?php echo get_template_directory_uri(); ?>/assets/js/jquery.sticky-sidebar-scroll.min.js"></script>
<script src="<?php echo get_template_directory_uri(); ?>/assets/js/wattcycling-custom.js"></script>
</footer>
